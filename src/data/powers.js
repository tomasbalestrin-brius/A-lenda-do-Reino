...
export const GENERAL_POWERS = {
  combate: [
    ...
    { 
      ...
      requisitos: { attr: { FOR: 1 }, pericia: ["Luta"] }
    },
    { 
    ...
    { 
      ...
      requisitos: { attr: { DES: 1 }, pericia: ["Luta"] }
    },
    { 
    ...
    { 
      ...
      requisitos: { pericia: ["Luta", "Fortitude"] }
    },
    { 
  ...
  destino: [
    ...
    { 
      ...
      requisitos: { pericia: ["Vontade"] } // Simplified
    },
    { 
      nome: "Lobo Solitário", 
    ...
    { 
      ...
      requisitos: { level: 2, pericia: ["Adestramento", "Diplomacia"] }
    },
    { 
